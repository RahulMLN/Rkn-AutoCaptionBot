...
async def start_cmd(bot, message):
    ...
    await message.reply_photo(photo=Rkn_Bots.RKN_PIC,
        ...
        reply_markup=types.InlineKeyboardMarkup([[
            types.InlineKeyboardButton('Uᴩᴅᴀᴛᴇꜱ', url='https://t.me/RS_Movie'),
            types.InlineKeyboardButton('Sᴜᴩᴩᴏʀᴛ', url='https://t.me/RS_Movie')
            ],[
            types.InlineKeyboardButton('🔥 Backup Channel 🔥', url='https://t.me/RS_Movie')
    ]]))
